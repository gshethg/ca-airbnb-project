...
rand_lng <- function(n = 10) rnorm(n, airbnb_data_trim$longitude, .01)
rand_lat <- function(n = 10) rnorm(n, airbnb_data_trim$latitude, .01)
m %>% addMarkers(
  rand_lng(), rand_lat(), popup = paste("price: ", airbnb_data_trim$price)
)
